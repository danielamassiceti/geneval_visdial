...
# copied from https://github.com/Maluuba/nlg-eval/blob/master/nlgeval/pycocoevalcap/meteor/meteor.py
...
class Meteor:
    ...
    def compute_score(self, gen, refs):
        assert isinstance(gen, six.string_types)
    
        refs = [a.strip() for a in refs]
        gts = {0: refs}
